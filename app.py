...
RISKY_KEYWORDS = [
    ...
    "scam", "fraud", "fake", "money", "phishing", "hacking", "cyber",
    "suspicious", "caution", "warning", "fraudulent", "alerting", "danger",
    "giveaway", "claim", "redeem", "urgent action", "immediate response",
    "give", "verify now", "secure your account",
    # Hindi
    ...
    "खतरा", "चेतावनी", "इनाम जीतना", "दावा करना", "रिडीम", "तत्काल कार्रवाई",
    "तुरंत जवाब", "देना", "अब सत्यापित करें", "अपने खाते को सुरक्षित करें",
    # Gujarati
    ...
    "આધાર", "ઠગમારી", "ફરિયાદ", "સાવધાન", "શંકાસ્પદ", "સુરક્ષિત", "જાળસાજી",
    "સંદેશ", "સંપર્ક", "ફોન", "ઇમેઇલ", "શંકાસ્પદ", "સાવચેત", "ઠગમારી", "ફિશિંગ", "હેકિંગ", "સાઇબર",
    "ખતરો", "ચેતવણી", "ઇનામ જીતવું", "દાવો કરવો", "રિડિમ", "તાત્કાલિક કાર્યવાહી",
    "તુરંત જવાબ", "આપવું", "હવે વેરિફાઈ કરો", "તમારા ખાતાને સુરક્ષિત કરો"
]
